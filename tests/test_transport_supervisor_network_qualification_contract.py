...
class TransportSupervisorNetworkQualificationContractTests(unittest.TestCase):
    ...
    def test_offline_observation_rejects_pid_churn_and_recovery_count_increase(self):
    ...
    def test_reconnect_requires_same_processes_and_full_ready_state(self):
    ...
    def test_success_requires_post_reconnect_heartbeat_and_machine_readable_summary(self):
        ...
        self.assertIn("TUNNEL_PID_STABLE", SOURCE)
