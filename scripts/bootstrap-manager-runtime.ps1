...
function Assert-ChatInstalledSixToolSemanticRuntime {
    ...
    $expectedPackageFiles = @(
        ...
        'lib/filesystem-semantic-provider.mjs',
        'lib/playwright-browser-semantic-provider.mjs',
    ...
    $controlPlaneFiles = @(
        ...
        'semantic_workspace_write.py',
        '_verified_workspace_artifact_runtime.py',
...
function Install-ChatManagerBundle {
    ...
    $runtimeFiles = @(
        ...
        @('runtime\semantic-projection\lib\browser-authorization-bridge.mjs', 'runtime\semantic-projection\lib\browser-authorization-bridge.mjs'),
        @('runtime\semantic-projection\lib\filesystem-semantic-provider.mjs', 'runtime\semantic-projection\lib\filesystem-semantic-provider.mjs'),
        @('runtime\semantic-projection\lib\playwright-browser-semantic-provider.mjs', 'runtime\semantic-projection\lib\playwright-browser-semantic-provider.mjs'),
        @('runtime\semantic-projection\lib\semantic-activation.mjs', 'runtime\semantic-projection\lib\semantic-activation.mjs'),
        @('runtime\semantic-projection\lib\workspace-write-bridge.mjs', 'runtime\semantic-projection\lib\workspace-write-bridge.mjs'),
        ...
        @('runtime\control_plane\local_state.py', 'runtime\control_plane\local_state.py'),
        @('runtime\control_plane\authorization.py', 'runtime\control_plane\authorization.py'),
        @('runtime\control_plane\semantic_browser_authorization.py', 'runtime\control_plane\semantic_browser_authorization.py'),
        @('runtime\control_plane\semantic_workspace_write.py', 'runtime\control_plane\semantic_workspace_write.py'),
        @('runtime\control_plane\_verified_workspace_artifact_runtime.py', 'runtime\control_plane\_verified_workspace_artifact_runtime.py'),
