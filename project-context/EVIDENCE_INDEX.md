...
- remaining Transport Supervisor v1 (#94) product-integration cleanup: eliminate the visible blank console window and split persistent user `desired_state` from runtime ownership before Stage 27 product integration;
