...
- That OpenAI/tunnel “control plane” terminology is unrelated to the project's **deterministic local execution Control Plane** (`CONTROL_PLANE.md`). The local Control Plane owns task/procedure/WorkingState, authorization, verification, reconciliation/recovery/budgets and Finish Gate logic; it does not require an additional paid AI service.
