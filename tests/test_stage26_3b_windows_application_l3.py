...
class WindowsApplicationL3Contracts(unittest.TestCase):
    ...
    def test_procedure_uses_registered_windows_mechanics_and_cannot_claim_external_done(self) -> None:
        ...
        self.assertIn('verify_windows_desktop_snapshots(', source)
        self.assertIn('WindowsDesktopObservationStream(', source)
        self.assertIn('evaluate_authorized(', source)
        self.assertIn('record_authorized_attempt(', source)
        ...
        self.assertEqual(source.count("_settle_postcondition("), 2)
